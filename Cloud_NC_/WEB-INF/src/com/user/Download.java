		...
		else
		{
    		...
    		if((st[0].trim().equals("1"))&&(st[1].trim().equals("2")))
    		{
    			...
    			if(flg)
    			{
    				...
    				File block_0=new File(root+"Block0/"+filename);
    				
    				FileInputStream stream3=new FileInputStream(block_0);
    	    		...
    	    		String dwn_data = req.getRealPath("")+"\\Files\\Download\\F1_Data.txt";
    	    		
    	    		FileOutputStream fStream = new FileOutputStream(dwn_data);
    	    		fStream.write(data3.trim().getBytes());
    	    		fStream.flush();
    	    		fStream.close();
    	    		
    	    		File f1=new File(root+"Block1/"+filename);
    				
    				FileInputStream stream2=new FileInputStream(root+"Block1/"+filename);
    	    		...
    	    		{
    	    			sb2.append(strLine2.trim());
    	    			System.out.println("strLine2 :"+strLine2);
    	    		}
    	    		String data2=sb2.toString().trim();
    	    		
    	    		String dwn_data1 = req.getRealPath("")+"\\Files\\Download\\F2_Data.txt";
    	    		
    	    		FileOutputStream fStream1 = new FileOutputStream(dwn_data1);
    	    		fStream1.write(data2.trim().getBytes());
    	    		fStream1.flush();
    	    		fStream1.close();
    	    		...
    	    		String merge_file=req.getRealPath("")+"\\Files\\Download\\half_"+filename;
    	    		
    	    		File file1=new File(dwn_data);
    	    		File file2=new File(dwn_data1);
    	    		
    	    		FileInputStream fileInputStream=new FileInputStream(file1);
    	    		FileInputStream fileInputStream2=new FileInputStream(file2);
    	    		
    	    		File merge_fileoutput=new File(merge_file);
    				...
    				try
    				{
						AES_File_EncNdec.decryptFile(merge_file, final_path2, "9988776655bbnngg");
		    		...
		    		status.append(final_path2.trim()+"~");
    		...
    		else if((st[0].trim().equals("1"))&&(st[1].trim().equals("3")))
    		{
    			...
    			if(flg)
    			{
    				...
    				try {
						AES_File_EncNdec.decryptFile(final_path1, final_path2, "9988776655bbnngg");
