...
<div style="position: absolute;background-color:#d4dedf; ">
	<!--Header-->
    <div class="header">
    <h1>User Login </h1>
    ...
    <a href="<%=request.getContextPath()%>/index.jsp" style="position: absolute;top: 330px;"><font style="color: #009999"><b>Are You a Admin?</b></font></a>
    </div>
    </div>
    <!--END Buttons-->
